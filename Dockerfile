...
RUN apt -y update && apt -y upgrade && \
  ...
  \
  wget https://github.com/manticoresoftware/executor/releases/download/v0.2.0/manticore-executor_0.2.0_${TARGET_ARCH}.deb && \
  dpkg -i manticore-executor_0.2.0_${TARGET_ARCH}.deb && \
  rm -f manticore-executor_0.2.0_${TARGET_ARCH}.deb
